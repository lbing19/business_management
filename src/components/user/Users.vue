<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data='userList' border stripe>
        ...
        <el-table-column label='操作'>
          <template v-slot='scope'>
            ...
            <el-tooltip effect='light' content='分配权限' placement='right' :enterable='false'>
              <el-button size='mini' type='primary' icon='el-icon-setting' plain round></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
      ...
      ></el-pagination>
      <!-- 添加新用户dialog -->
      <el-dialog title='添加新用户' :visible.sync='dialogVisible' width='50%' @close='closeDialog'>
        <!-- 用户信息form表单 -->
